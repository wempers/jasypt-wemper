...
public class JasyptEncryptorConfigurationProperties {
    ...
    public static class PropertyConfigurationProperties {
        ...
        /**
         * Specify the name of the bean to be provided for a custom {@link com.wemper.jasypt.EncryptablePropertyDetector}.
         * Default value is {@code "encryptablePropertyDetector"}
         */
        private String detectorBean = "encryptablePropertyDetector";

        /**
         * Specify the name of the bean to be provided for a custom {@link com.wemper.jasypt.EncryptablePropertyResolver}.

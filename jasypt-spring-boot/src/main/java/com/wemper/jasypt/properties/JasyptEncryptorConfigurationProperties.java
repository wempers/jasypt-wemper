...
public class JasyptEncryptorConfigurationProperties {
  ...
  /**
   * Whether to use JDK/Cglib (depending on classpath availability) proxy with an AOP advice as a decorator for existing {@link org.springframework.core.env.PropertySource} or just simply use targeted wrapper Classes.
   * Default Value is {@code false}.
   */
  private Boolean proxyPropertySources = false;

  /**
   * Specify the name of bean to override jasypt-spring-boot's default properties based {@link org.jasypt.encryption.StringEncryptor}. Default Value is {@code jasyptStringEncryptor}.
   */
  ...
  /**
   * Encryption/Decryption Algorithm to be used by Jasypt. For more info on how to get available algorithms visit: <a href="http://www.jasypt.org/cli.html"/>Jasypt CLI Tools Page</a>. Default Value is {@code
   * "PBEWithMD5AndDES"}.
   *
   * @see org.jasypt.encryption.pbe.PBEStringEncryptor
  ...
  /**
   * The name of the {@link java.security.Provider} implementation to be used by the encryptor for obtaining the encryption algorithm. Default Value is {@code null}.
   *
   * @see org.jasypt.encryption.pbe.PBEStringEncryptor
  ...
  /**
   * A {@link org.jasypt.salt.SaltGenerator} implementation to be used by the encryptor. Default Value is {@code "org.jasypt.salt.RandomSaltGenerator"}.
   *
   * @see org.jasypt.encryption.pbe.PBEStringEncryptor
  ...
  /**
   * Specify the form in which String output will be encoded. {@code "base64"} or {@code "hexadecimal"}. Default Value is {@code "base64"}.
   *
   * @see org.jasypt.encryption.pbe.PBEStringEncryptor
  ...
  public static class PropertyConfigurationProperties {
    ...
    /**
     * Specify the name of the bean to be provided for a custom {@link com.wemper.jasypt.EncryptablePropertyDetector}. Default value is {@code "encryptablePropertyDetector"}
     */
    private String detectorBean = "encryptablePropertyDetector";

    /**
     * Specify the name of the bean to be provided for a custom {@link com.wemper.jasypt.EncryptablePropertyResolver}. Default value is {@code "encryptablePropertyResolver"}
     */
    private String resolverBean = "encryptablePropertyResolver";

    /**
     * Specify a custom {@link String} to identify as prefix of encrypted properties. Default value is {@code "ENC("}
     */
